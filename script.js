...
// let something = document.querySelector('#') // the query selector returns the first element that matches this
/**************
 *   SLICE 1
 **************/
...
function updateCoffeeView(coffeeQty) {
  ...
  coffee_counter.innerHTML = coffeeQty;
...
producerContainer.addEventListener("click", (e) => {
  console.log(e);
  buyButtonClick(e, data);
});
